...
export function GoalsSection() {
  return (
    <Section
      id="goals"
      eyebrow="03 — Цели"
      title="Три горизонта. За год — машина правды. За пять — стандарт категории"
      lead="Цель «стать мировым лидером» без горизонта — постер. 12 месяцев устанавливают операционную систему. 3 года делают вас претендентом, которого сравнивают с инкамбентами. 5 лет — если клин выбран верно — позволяют задать язык категории."
    >
