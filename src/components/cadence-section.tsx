...
export function CadenceSection() {
  return (
    <Section
      id="cadence"
      eyebrow="05 — Каденция"
      title="Ритм, в котором метрики становятся решениями"
      lead="Метрика без каденции — коллекционирование. Каденция без kill-criteria — ритуал. Ниже — минимальный ритм компании, которая целится в мировой стандарт. Всё остальное в календаре должно уметь умереть."
    >
