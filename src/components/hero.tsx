    ...
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pt-16 pb-20 sm:px-6 sm:pt-24 sm:pb-28">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground sm:text-xl">
          Выручки у ИТ нет. Эффективность — не «все заняты» и не «сэкономили на штате».
          Это когда акция и касса для магазина работают быстрее и стабильнее, а на это
          уходит меньше редких людей и меньше бесконечных согласований.
        </p>
