...
export function CultureSection() {
  return (
    <Section
      id="culture"
      eyebrow="04 — Культура"
      title="Культура — это операционная система, а не ценности на стене"
      lead="Процессы без культуры превращаются в театр. Культура без метрик — поэзия. Десять правил ниже описывают наблюдаемое поведение: как выглядит и как не выглядит. Если правило нельзя увидеть в найме, в RFC и в инциденте — его нет."
    >
